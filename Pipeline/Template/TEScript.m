...
cfgTEP.predicttimemax_u    = 70;	  % maximum u to be scanned
cfgTEP.predicttimestepsize = 5; %Information Transfer delay
...
cfgTEP.maxlag      = 7000;  % max. lag for the calculation of the ACT
cfgTEP.actthrvalue = 5000;   % threshold for ACT
%Manually Change
...
%permits.
%Default State-Space Embedding Method
cfgTEP.optimizemethod ='ragwitz';  % criterion used
cfgTEP.ragdim         = 1:5;       % dimensions d to be used
cfgTEP.ragtaurange    = [0 0.1]; % tau range to be used
cfgTEP.ragtausteps    = 25;         % steps for ragwitz tau
cfgTEP.repPred        = 3000;       % no. local prediction/points used for the Ragwitz criterion

%Leave Unchanged, has been shown to be the optimal settings
